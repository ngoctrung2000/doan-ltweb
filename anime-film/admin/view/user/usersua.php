                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <form method="POST"
                                        action="index.php?controller=usercontroller&action=xulysua&id=<?php echo $_GET['id']?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputEmail1"
                                                aria-describedby="emailHelp" placeholder=" email" name="usernamelogin"
                                                value='<?php  echo $arr['usernamelogin'];?>'>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Mail</label>
                                            <input type="mail" class="form-control" id="exampleInputEmail1"
                                                aria-describedby="emailHelp" placeholder=" email" name="usermail"
                                                value='<?php echo $arr['usermail'];?>'>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Password</label>
                                            <input type="password" class="form-control" id="exampleInputPassword1"
                                                placeholder="Password" name="userpasslogin"
                                                value='<?php echo $arr['userpasslogin'];?>'>
                                        </div>


                                        <div class="modal-footer no-b   d">
                                            <button type="submit" id="addRowButton" class="btn btn-primary"
                                                name=sua>Sửa</button>
                                            <button herf="index.php?controller=usercontroller&action=index"
                                                type="submit" class="btn btn-danger" data-dismiss="modal">Thoát</button>
                                        </div>
                                        <?php } ?>
                                    </form>
                                </div>
