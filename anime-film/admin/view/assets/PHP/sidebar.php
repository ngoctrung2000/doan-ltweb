<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="pages/forms/loginForm.php">
                <i class="mdi mdi-view-headline menu-icon"></i>
                <span class="menu-title">Login</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="pages/forms/RegisterForm.php">
                <i class="mdi mdi-view-headline menu-icon"></i>
                <span class="menu-title">Register</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="pages/tables/userlist.php">
                <i class="mdi mdi-view-headline menu-icon"></i>
                <span class="menu-title">Manager User</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="pages/tables/filmlist.php">
                <i class="mdi mdi-view-headline menu-icon"></i>
